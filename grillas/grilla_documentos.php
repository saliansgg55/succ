...
$('body').on('click','#listadocumentos a',function (e){
      ...
      //alert(id_doc + ' ' + accion);
       ...
       }else if(accion == 'elimina_doc'){ //cierra IF ver doc    
...
$("#dialog-confirm-doc-movil").removeClass('hidden');
 $(function() {
    $("#dialog-confirm-doc-movil").dialog({
      resizable: false,
      height: "auto",
      width: "auto",
      modal: true,
...
<div id="dialog-confirm-doc-movil" title="ELIMINAR REGISTRO DE FORMA PERMANENTE?" class="hidden">
...
<div class="panel-body bordelista">
 ...
 <div class="alert alert-info" role="alert" align="center">
  <h3>DOCUMENTACION MOROSIDAD MOVIL</h3>
 <hr>
