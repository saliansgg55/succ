...
<link rel="stylesheet" type="text/css" href="css/modal-head.css">


</head>
<body>

<div id="dialog-message-asigna" title="MENSAJE INFORMATIVO" class="hidden">
...
<div class="container-fluid">
  <!-- Modal -->
  <div class="modal fade" id="myModalAsigna" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <!-- FORMULARIO ASIGNA NUEVO GRUPO -->
           ...
           <div class="row">
             <form class="form-horizontal" id="form_asignaciones_g">
               ...
               <div class="form-group ">
                  ...
                  <input type="text" class="form-control hidden" id="accion" name="accion" value="asigna_grupo">
                </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary">GUARDAR CAMBIOS</button>
                  <!--<a href="#" id="guarda_asignacion_guardar" class="btn btn-primary"  data-dismiss="modal"> GUARDAR CAMBIOS </a>-->
                </div>
        ...
        <div class="modal-footer">
          ...
          <!--<a href="#" id="edita_asignacion" class="btn btn-primary hidden" data-dismiss="modal" > Guardar </a>-->
