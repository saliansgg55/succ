...
<div id="dialog-message-fija" title="MENSAJE INFORMATIVO" class="hidden">
  <p> Debe completar los campos obligatorios. </p>
</div>

<div class="container-fluid">
  <!-- Modal -->
  <div class="modal fade" id="myModalSubeFija" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Subir Documento Morosidad Fija</h4>
        </div>
        ...
        <!-- FORMULARIO ASIGNA NUEVO GRUPO -->
           <br>
            <div class="row">
                ...
                <div class="alert alert-warning" role="alert">
                  <b>!IMPORTANTE</b>   
                  <a class="" data-toggle="collapse" href="#collapseExample_fija" role="button" aria-expanded="false" aria-controls="collapseExample_fija"> Ver ejemplo </a> Al guardar el .doc hacerlo en <STRONG>formato PDF</STRONG>.
                </div>

                <div class="collapse" id="collapseExample_fija">
           ...
           <div class="row">
              ...
              <div class="col-lg-8 "><!-- formulario para subir la documentacion -->
                <form class="form-horizontal" id="form_sube_doc_fija">
                  <!--<div class="col-lg-6 ">-->

                     <div class="form-group ">                  
                        <label for="email">Casuistica: </label> 
                        <!--<input type="text" class="form-control hidden" id="go_id" name="go_id" >-->
                        <input type="text" required class="form-control" id="casuis" name="casuis" placeholder="Breve Descripcion del problema" required >
                        <input type="text" class="form-control hidden" id="accion" name="accion" value="sube_fija">                    
                     </div>
