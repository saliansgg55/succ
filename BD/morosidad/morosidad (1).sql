...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-08-2018 a las 22:04:39
...
(28, 'Contingencia de la configuracion de la promo', 0x433a78616d7070096d70706870424539302e746d702e6170706c69636174696f6e2f706466, '22-08-2018', 'u584580', '', 'Contingencia de la configuracion de la promo.pdf');
...
(49, 'DEIMOS', 'GO_COBRANZAS', '', '', 'Go_cobranzas', 'Fija/Movil', NULL, 'Abaco-Deimos-des', 'Walter Morales', '', '10-08-2018'),
...
(53, 'JANO', 'GO_BUSINESS_INTELLIGENCE', '', '', 'SA BI PLATAFORMA JANO', 'Fija', NULL, '', 'Juan ortiz - Cristian Planes', '', '10-08-2018'),
...
(55, 'GIRAFE', '', '', '', 'APLF_COR_GIRAFE_PROV / ADMF_COR_GIRAFE\"', 'Fija', NULL, 'SoporteAplicativosUV@teco.com.ar', 'Marcelo Alberto Ballesteros', '', '22-08-2018'),
...
--
ALTER TABLE `documentos_fija`
  MODIFY `id_doc_f` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `grupos`
  MODIFY `go_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT de la tabla `pm`
--
ALTER TABLE `pm`
  MODIFY `id_pm` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
...
--
ALTER TABLE `usuarios`
  MODIFY `id_user` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
