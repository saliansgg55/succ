...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-03-2019 a las 13:28:48
...
(31, 'CBCARTAS NO TIENE LINEA ASOCIADA', 0x433a78616d7070096d70706870453530372e746d702e6170706c69636174696f6e2f706466, '12-02-2019', 'u584580', '', 'CBCARTAS-NO_TIENE_LINEAS_ASOCIADAS_AL_CONTRATO.pdf'),
(32, 'Modificar  o crear gerencias', 0x433a78616d7070096d70706870314143462e746d702e6170706c69636174696f6e2f706466, '28-03-2019', 'u584580', '', 'MODIFICAR_CREAR_GERENCIAS.pdf');
...
(32, 'GUC CANCELAR LOTE', 0x433a78616d7070096d70706870463141322e746d702e6170706c69636174696f6e2f706466, '12-02-2019', 'u584580', 'IM02435839', 'GUC_CANCELAR_LOTE.pdf'),
(33, 'SUSPENSIONES ABONO FIJA', 0x433a78616d7070096d70706870343731352e746d702e6170706c69636174696f6e2f706466, '12-02-2019', 'u584580', 'IM02440693 ', 'SUSPENSIONES_DE_ABONO_FIJA.pdf'),
(34, 'PEDIDO PROVISION PENDIENTE RH', 0x433a78616d7070096d70706870443245322e746d702e6170706c69636174696f6e2f706466, '22-03-2019', 'u584580', '', 'PEDIDO_PROV_PEND_RH.pdf');
...
(90, 'Desarrollo FIJA', 'APLF_AC_GEO_EVA_GUC_PROV', '', '', 'abaco-morosidad-evo', 'Fija', NULL, 'abaco-morosidad-evo', '', '', '08-03-2019'),
(91, 'Cerrar PMS resueltos', '', '', '', '', 'Fija', NULL, 'Abaco-morosidad-corr', '', '', '17-10-2018'),
(92, 'POSVENTA', 'APLF_COR_GO_POSVENTA', '', '', '', 'Fija', NULL, '', '', '', '12-02-2019'),
(93, 'EVA', 'APLF-COR-GO-EVA', '', '', '', 'Fija', NULL, '', '', '', '14-03-2019');
...
(10, 'Julian', 'Faletti', 'u618378', '', 'u618378', '2019-03-13 11:24:42');
...
--
ALTER TABLE `documentos_fija`
  MODIFY `id_doc_f` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
...
--
ALTER TABLE `grupos`
  MODIFY `go_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
--
...
--
ALTER TABLE `usuarios`
  MODIFY `id_user` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
