...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2020 a las 04:17:52
...
CREATE TABLE `documentos` (
  ...
  `doc_contenido` longblob DEFAULT NULL,
...
(1, 'documento', 0x2e, '05-11-2020', 'admin', '23423', 'MATEMÁTICA 23 -LA DIVISIÓN - DIVERSAS ESTRATEGIAS DE RESOLUCIÓN.docx');
...
CREATE TABLE `documentos_fija` (
  ...
  `doc_contenido_f` longblob DEFAULT NULL,
...
(1, 'Admin', 'Administrador', 'admin', 'gsalinas@teco.com.ar', 'admin', '2020-11-05 03:09:01'),
...
--
ALTER TABLE `documentos_fija`
  MODIFY `id_doc_f` int(11) NOT NULL AUTO_INCREMENT;
