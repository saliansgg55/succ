...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2016 a las 02:46:39
...
(10, 'CBDMSMC', 'Error: Hay otra instancia del programa que se encuentra corriendo.', 'Envio morosos a deimos', '', 'Verificar si en la cadena del dia anterior no se encuentra en ejecucion el mismo job. En caso contrario, solicitar a operaciones: \n1. Conectarse al equipo BSCS_CC\n2. Ir al path: /tmp\n3. Eliminar el archivo cbdmsmc.pid\n4. Dar condicion y RERUN al job CBDMSMC de la cadena ABOGADOS --> ABO_DEIMOS', 'Sin acciones', 'Sin acciones', 'Sin acciones', 'Sin acciones', '1525361795', '1130726517'),
...
--
ALTER TABLE `morosidad`
  MODIFY `moro_id` mediumint(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
